...
import { FiHome, FiPackage, FiDollarSign, FiSettings, FiLogOut, FiMenu, FiX, FiPercent, FiBookOpen, FiUser, FiMessageCircle, FiShoppingBag, FiShoppingCart, FiCalendar, FiChevronLeft, FiChevronRight, FiShield, FiRepeat, FiCreditCard, FiZap } from 'react-icons/fi';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { href: '/gerador', icon: <FiZap size={18} />, label: 'Gerador Inteligente' },
